...
- [-] 8. نقطة تفتيش - اختبارات الخصائص
  - تشغيل `npm run test` للتأكد من نجاح جميع الاختبارات
  - سؤال المستخدم إذا كانت هناك أسئلة

- [ ] 9. اختبارات الخطافات والسياقات (Wave 5)
  - [~] 9.1 اختبارات usePermissions
  ...
  - [~] 9.2 اختبارات useDebounce و useDebouncedCallback
  ...
  - [~] 9.5 اختبارات useOptimisticUpdate
  ...
  - [~] 9.6 اختبارات usePersistedFilters و useKeyboardShortcuts
  ...
  - [~] 9.8 اختبارات NotificationContext
  ...
  - [~] 9.9 اختبارات PreferencesContext
...
- [~] 10. نقطة تفتيش - اختبارات الخطافات والسياقات
  - تشغيل `npm run test` للتأكد من نجاح جميع الاختبارات
  - سؤال المستخدم إذا كانت هناك أسئلة

- [ ] 11. اختبارات العميل: الأدوات والخدمات والمكونات (Wave 6)
  - [~] 11.1 اختبارات خصائص CryptoUtils
  ...
  - [~] 11.2 اختبارات خصائص SecureStorage
  ...
  - [~] 11.5 اختبارات خدمة API (interceptors)
  ...
  - [~] 11.6 اختبارات مكونات واجهة المستخدم العامة
  ...
  - [~] 11.8 اختبارات وحدات التطبيق الرئيسية
  ...
  - [~] 11.9 اختبارات إمكانية الوصول (Accessibility)
