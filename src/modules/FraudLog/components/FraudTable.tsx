          ...
          <tbody className="divide-y divide-[var(--color-border-soft)]">
            {cases.map((item) => (
              <tr key={item.id} className="hover:bg-[var(--color-primary)]/5 transition-colors group">
                ...
                <td className="p-6 text-sm font-bold text-slate-800 min-w-[200px]" title={item.condition}>
                ...
                <td className="p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <button 
                      ...
                      className="p-1.5 rounded-lg hover:bg-slate-200 text-slate-500 hover:text-primary transition-all shadow-sm border border-slate-200 bg-white"
                    >
